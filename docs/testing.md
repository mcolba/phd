...
- **Property-based tests**: Use property-based tests when exact expected values are difficult to specify or when the input space is too large to cover manually.
